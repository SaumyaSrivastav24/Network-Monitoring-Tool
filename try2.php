...
<div style="margin-top:5%;margin-left:28%;width:35%;padding-bottom:7%;padding-top:8%;padding-left:8%;background-color:#feff1a;">

<form name="myform" action="try3a.php"  method="post">
<div style="padding:5%;margin-right:13%;margin-left:-11%;background-color:#feff00;">
<table style="padding:2%;background-color:#e5e600;margin-left:7%">
<tr>
